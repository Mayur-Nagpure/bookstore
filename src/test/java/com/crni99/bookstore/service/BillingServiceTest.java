...
class BillingServiceTest {
	...
	void findPaginated_shouldReturnPaginatedBooks() {
		...
		books1.add(book1);
		Order order1 = new Order(1L, LocalDate.now(), customer1, books1, "NEW");
		...
		books2.add(book2);
		Order order2 = new Order(2L, LocalDate.now(), customer2, books2, "NEW");

		Book book3 = new Book();
		List<Book> books3 = new ArrayList<>();
		books3.add(book3);
		Order order3 = new Order(3L, LocalDate.now(), customer2, books3, "NEW");
	...
	void shouldCreateOrder() {
		...
		billingService.createOrder(customer, books,"CASH");
